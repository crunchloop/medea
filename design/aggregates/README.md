...
| **ClusterRollout** | Version Rollout (core) | `pb.ClusterRollout` | one record per `cluster` | K8s path deferred (M3); currently `Unimplemented` | [`cluster-rollout.md`](cluster-rollout.md) |
